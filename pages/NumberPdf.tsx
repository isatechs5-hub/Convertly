...
import { ArrowLeft, Download, Loader2, Hash, Plus, Trash2 } from 'lucide-react';
import { AppView } from '../types';
import { addPageNumbers } from '../services/pdfUtils';

interface Props {
  setView: (view: AppView) => void;
}

export const NumberPdf: React.FC<Props> = ({ setView }) => {
      ...
      <div className="max-w-3xl mx-auto px-4">
        <div className="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden">
          <div className="p-8 text-center border-b border-slate-100 bg-slate-50/50">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-2">Number Pages</h2>
            <p className="text-slate-500 max-w-md mx-auto">Add page numbering to your document.</p>
          </div>
          ...
          <div className="p-8">
            ...
            >
              {isProcessing ? <Loader2 className="animate-spin h-6 w-6" /> : <Hash className="h-6 w-6" />}
